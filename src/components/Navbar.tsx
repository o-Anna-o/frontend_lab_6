...
export default function Navbar(){
  ...
  async function fetchBasket() {
    ...
    try {
      ...
      if (!json) {
        setCount(null); setRequestId(null); return
      }
      let c = null; let id = null
      ...
      setCount(c); setRequestId(id)
    } catch(e) {
      setCount(null); setRequestId(null)
    }
  }
  ...
  return (
    <div style={{width:'100%', display:'flex', justifyContent:'center', position:'relative'}}>
      <div style={{position:'absolute', left:12, top:12}}>
        {count && count > 0 ? (
          <a href={requestId?('/request_ship/'+requestId):'/request_ship'} className="cart-link" style={{textDecoration:'none'}}>
      ...
      <a href="/ships"><img src="/resources/img/home-img.svg" alt="home" style={{height:40}} /></a>
    </div>
  )
}
